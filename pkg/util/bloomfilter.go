...
func NewBloomfilterFromBytes(bytes []byte, hashCount int) *Bloomfilter {
	return &Bloomfilter{byteArray: bytes, byteArraySize: len(bytes), hashCount: hashCount}
}
...
func (x *Bloomfilter) ToBytes() []byte {
	return x.byteArray
}
